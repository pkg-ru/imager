...
- **Анимированные изображения** — GIF/WebP с лимитами на кадры и
  ...
  Анимированный вход → **AVIF** сохраняет анимацию (нативный libheif
  sequence encoder, настоящий animation track). Анимированный вход →
  **HEIF/HEIC** возвращает корректный статичный файл с первым кадром:
  HEIF/HEIC не поддерживают анимированный выход в текущей Imager
  (ограничение реализации/нативных библиотек, не ошибка входа) —
  см. [PROCESSING.md](docs/PROCESSING.md#анимации).
