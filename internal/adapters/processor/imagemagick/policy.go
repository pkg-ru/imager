...
// отключена.
//
// Запись атомарна (I8/N6): данные пишутся во временный файл в том же
// каталоге и переименовываются в policy.xml, чтобы ImageMagick никогда не
// увидел частично записанный файл.
