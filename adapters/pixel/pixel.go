...
// Формат — расширение без точки (например "png", "webp"). Если встроенного
// файла для формата нет — возвращается ошибка (вызывающий перейдёт к
// следующему not-found fallback).
//
